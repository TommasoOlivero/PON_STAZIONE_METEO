...
def main():
    ...
    ##################               Printing of the acquired data                #############################   

    print(f"PRESSIONE:           {pressione_valore} mm")
    print(f"UMIDITA' INTERNA:    {umi_int_valore} %")
    print(f"UMIDITA' ESTERNA:    {umi_est_valore} %")
    print(f"TEMPERATURA INTERNA: {temp_int_valore} °C")
    print(f"TEMPERATURA ESTERNA: {temp_est_valore} °C")
    print(f"DAYLI RAIN:          {rain_valore} mm")
    print(f"VENTO:               {vento_valore} km/h")

    ##################      opening of windows for data visualization     ####################
    cv2.imshow('im', im)
